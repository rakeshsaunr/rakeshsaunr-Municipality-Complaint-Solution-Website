...
<body>
	...
	<nav class="navbar navbar1 bg-light" style="float:left;margin-top:0px;display:block;
		...
		<ul class="navbar-nav" style="width:100%;background-color:#17a2b86e;">
			<li class="nav-item">
				<img src="image/user.png" width="90px" height="80px">
			</li>
			<li class="nav-item">
	...
	<div id="main" style="width:78%;float:left;">
		...
		<div class="" id="makecomplaint" style="width:100%;display:none;border-radius:15px;padding:15px;margin:10px;background-color:rgba(32, 76, 5, 0.1);border:1px solid aqua;">
			...
			<form class="form" action="usermakecomp.php" method="POST" style="width:100%;" enctype="multipart/form-data">
				...
				<select id="category" name="category" style="width:30%;border-radius:12px;height:37px;">
					<option>Other</option>
					<option>Municipality Members</option>
				...
				<br /><br />
				<span id="span2">Name of Complaint</span><input type="text" name="nature" class="form-control in2" placeholder="Regarding to ...."><br />
		...
		<div class="" id="pending" style="width:90%;display:none;border-radius:15px;padding:15px;margin:10px;background-color:rgba(32, 76, 5, 0.1);border:1px solid aqua;">
			...
			if ($result) {
				...
				echo "<th>Number</th><th>Category</th><th>Sub-Category</th><th>Name</th><th>Date & Time</th><th>File</th><th>Complaints</th></tr>";
				$num = 0;
				while ($row = mysqli_fetch_assoc($result)) {
					if ($user == $row['user']) {
						$cme = $row['pending'];
							...
							while ($row = mysqli_fetch_assoc($result)) {
								...
								if ($id == $inid) {
									...
									echo "
											 ...
											 Complaint-Name:        <span id='span'>$nat</span><br />
	...
	<div id="foot" style="background-color:rgb(252, 251, 251);height:80px;width:100%;float:left;margin-top:10px;text-align:center;">
		<p style="color: #000C66; font-family: Arial, Helvetica, sans-serif;"><img src="image/copyright-icon.png" alt="Logo image" width="25px" height="25px ">2024<span>|</span> All Rights Reserved <a href="https://Municipality Complaint Solution/">Municipality Complaint Solution</a></p>
	</div>
