...
<body>
	...
	<nav class="navbar-nav navbar-expand-sm bg-primary" style="margin:0px;padding:0px;">
		...
		<div class="nav-item item1" style="margin-left:5%">
			<img src="image/admin.png" style="border-radius:15%;margin-left:25%;float:left" width="70px" height="80px">
