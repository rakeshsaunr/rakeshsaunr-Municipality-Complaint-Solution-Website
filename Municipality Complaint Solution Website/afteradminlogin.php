...
<i class="fa fa-reorder" onclick="callsh()" style="cursor:pointer;font-size:24px;margin:20px 2px 0px 20px;color:white"></i>
		...
		<nav  class="navbar navbar1 bg-primary" style="float:left;margin:0px;display:block;padding:0px;box-shadow:.2px 1px 2px 1px;" id="sh_menu">
			<!-- Links -->
		...
		<div class="" id="logindata" style="width:97%;float:left;display:none;border-radius:15px;padding:15px;margin:10px;background-color:rgba(91, 12, 9,.1);border:1px solid aqua;">
			...
			<div id="foot" style="background-color:white;height:80px;width:100%;float:left;margin-top:10px;text-align:center;padding:20px">
			<i class="bi bi-c-circle"></i> 2023 Copyright:
    <a href="https://MunicipalityComplaint Solution/"> Municipality Complaint Solution</a>
		</div>
