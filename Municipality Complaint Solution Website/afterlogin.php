...
<i class="fa fa-reorder" onclick="callsh()" style="cursor:pointer;font-size:24px;margin:10px 2px 0px 20px;color:white"></i>		
  ...
  <ul class="navbar-nav" style="width:100%;background-color:#17a2b86e;">
	...
	{						echo "<table class='table'><tr class='tr'>";
									echo "<th>Number</th><th>Category</th><th>Sub-Category</th><th>Name</th><th>Date & Time</th><th>File</th><th>Message</th></tr>";
									$num=0;
		while($row=mysqli_fetch_assoc($result))
		{
			if($user==$row['user'])
								...
								{				
										...
										if($id==$inid)
										{
											...
											echo "<a href='$fil' target='_blank'>view file</a><br />";
											 ...
											 Message >               <span id='span'>$co</span><br /></h6><br /><hr />";
										}
	...
	if($num==0)
	{
		...
		<div id="foot" style="background-color:white;height:80px;width:100%;float:left;margin-top:10px;text-align:center;">
		<i class="bi bi-c-circle"></i> 2023 Copyright:
    <a href="https://Municipality Complaint Solution/">Municipality Complaint Solution</a>
		</div>
